---
title: "Tip: keep publish date in one place "
lead: ""
tags: [tip]
isDraft: true
authors:
...
The DRY principle has me hard. In the [realease beta16](blog/release-1.0.0-beta.16) of BlazorStatic I intruduced the option to store you md files in a structure where
...
Now - I like to call the posts (the folders here) by their title (`post1`). But i also like to keep them chronologically.
